...
class Cart extends Component {
  ...
  PageRefresh = () => {
    ...
    // const currentTime = Date.now() / 1000 + 86200;
    // console.log(currentTime);
    // if (parseFloat(expiresAt) < currentTime) {
    //   // Token has expired, log the user out
    //   localStorage.removeItem("token");
    //   localStorage.removeItem("expires_in");
    //   // this.setState({ loggedIn: false });
    //   // Perform automatic logout action here
    // }
  };
  ...
  confirmOnClick = () => {
    ...
    if (city.length === 0) {
      toast.error("Please Select City", { position: toast.POSITION.TOP_RIGHT });
