                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="size" class="form-control visually-hidden"
                                                    data-role="tagsinput" value="S,M,L,XL, XXL, XXXL">
                                            </div>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" name="remark1" type="checkbox"
                                                    value="FEATURED" id="flexCheckDefault">
                                                <label class="form-check-label" for="flexCheckDefault">FEATURED</label>
                                            </div>

                                            <div class="form-check">
                                                <input class="form-check-input" name="remark2" type="checkbox"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" name="remark3" type="checkbox"
